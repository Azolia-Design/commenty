...
function main_defineProperty(obj, key, value) {
 ...
 //let URL_THEMES = `${window.location.origin}/commenty_wp/wp-content/themes/commenty_theme`;

var URL_THEMES = "".concat(window.location.origin, "/commenty/wp-content/themes/commenty_theme"); //let URL_THEMES = window.location.origin;
...
//     } else if ($('.pricingpage').length) {
//         console.log("It's Pricing");
//         $('#pricingPage').addClass('active');
//         $('#navPricing').addClass('active');
//     } else if ($('.featurespage').length) {
//         console.log("It's Features");
//         $('#featuresPage').addClass('active');
//         $('#navFeatures').addClass('active');
//     } else if ($('.supportpage').length) {
//         console.log("It's Support");
...
jquery_default()(document).ready(function () {
  var header = jquery_default()('.header'),
      progressbar = jquery_default()('.progressbar'),
      scrollMain = jquery_default()('.scrollmain'),
      btnMobile = jquery_default()('.header__btnmenu'),
      btnCloseMobile = jquery_default()('.navmobile__button'),
      wrapper = jquery_default()('.wrapper'),
      navMobile = jquery_default()('.navmobile'); ///////////////////////// MENU MOBILE CLICKED ///////////////////////////////

  var flagClickMenu = 1;
  btnMobile.click(function () {
    if (flagClickMenu != 0) {
      wrapper.addClass('--show-nav').addClass('--overflow-hidden');
      navMobile.addClass('--show-nav');
      setTimeout(function () {
        btnCloseMobile.addClass('active');
      }, 500);
    }
  });
  btnCloseMobile.click(function () {
    if (flagClickMenu == 1) {
      btnCloseMobile.removeClass('active');
      wrapper.removeClass('--show-nav');
      navMobile.removeClass('--show-nav');
      setTimeout(function () {
  ...
  var headerLinks = jquery_default()('.header .header__nav li a');
  var navLinks = jquery_default()('.navmobile .navmobile__inner li a'); /////////////////////////////// SCROLL //////////////////////////////////////
  ...
  locoScroll.on('scroll', function (instance) {
    if (jquery_default()('html').hasClass('has-scroll-smooth')) {
      var percentScroll = 100 * instance.delta.y / instance.limit.y;
      progressbar.css({
        width: percentScroll + '%'
      });
    }
    ...
    if (instance.direction == 'up') {
      ...
      } else if (instance.scroll.y < header.height()) {
        header.removeClass('--bgwhite');
      }
    } else if (instance.direction == 'down' && instance.scroll.y > header.outerHeight()) {
  ...
  //     loop: true,
  //     autoplay: true,
  //     path: 'json/data_comp_final1.json'
  // });


  function interactionProSol() {
    var sectionProSol = jquery_default()('.scprosol'),
        contentProSol = jquery_default()('.scprosol__content-inner');

    if (sectionProSol.length) {
      var tlSectionProSol = gsapWithCSS.timeline({
        scrollTrigger: {
          trigger: sectionProSol,
          scroller: scrollMain,
          scrub: 0,
          pin: true,
          start: "top top",
          end: "+=300%",
          // animation: tlCardCollab,
          // toggleClass: 'active',
          ...
          // markers: true,
          onUpdate: function onUpdate(seft) {
            var progress = seft.progress.toFixed(2) * 100;

            if (progress > 50) {
              gsapWithCSS.to('.scprosol__circle-item.--pro', {
                opacity: 0
              });
              gsapWithCSS.to('.scprosol__circle-item.--sol', {
                opacity: 1
              });
      ...
      tlSectionProSol.to(contentProSol, {
        y: '-69%'
      });
    }
  } //addLottieProSol();
  // function addVideoProSol() {
  //     let videoProSol = $('.scprosol__circle .mask');
  //     videoProSol.html(`<video src="${URL_THEMES}/video/Users_5.mp4" loop autoplay muted playsinline></video>`);
  // }
  // addVideoProSol();


  function sliderProSolMobile() {
    var _Flickity;

    var contentProSol = document.querySelector('.scprosol__content-inner');
    var Slide_ProSol = new (js_default())(contentProSol, (_Flickity = {
      cellAlign: 'left',
      contain: true,
      prevNextButtons: false,
      pageDots: false
    }, main_defineProperty(_Flickity, "cellAlign", 'left'), main_defineProperty(_Flickity, "dragThreshold", 10), main_defineProperty(_Flickity, "on", {
  ...
  function interactionCollab() {
    ////////////////// INTERACTION SECTION COLLAB ////////////////////
    var sectionCollab = jquery_default()('.sccollab'),
        titleCollab = jquery_default()('.sccollab__textbox');

    if (sectionCollab.length) {
      var tlCollab = gsapWithCSS.timeline({
        scrollTrigger: {
          trigger: titleCollab,
          scroller: scrollMain,
          scrub: 0,
      ...
      var tlCardCollab = gsapWithCSS.timeline({
        scrollTrigger: {
      ...
      tlCardCollab.from(['.sccollab__boxs-col:nth-child(2) .item:nth-child(1)', '.sccollab__boxs-col:nth-child(1) .item:nth-child(1)', '.sccollab__boxs-col:nth-child(2) .item:nth-child(2)', '.sccollab__boxs-col:nth-child(1) .item:nth-child(2)', '.sccollab__boxs-col:nth-child(2) .item:nth-child(3)'], {
        duration: 2,
        autoAlpha: 0,
        y: 300,
        stagger: 0.6
  ...
  function interactionWork() {
    ...
    if (eleWork.sectionWork.length) {
      var tlContentWork = gsapWithCSS.timeline({
        scrollTrigger: {
          trigger: eleWork.sectionWork,
          scroller: scrollMain,
          start: "-50% 0%",
          end: '0% 0%'
        },
  ...
  var vSlide = gsapWithCSS.timeline({
    repeat: -1
  });

  function animationRepeatTextWork() {
    if (jquery_default()('.scworks__text-list .title').length) {
      var textWork = {
  ...
  //         counterTextWork++;
  //     } else if (counterTextWork == textWork.length) {
  //         counterTextWork = 1;
  //     }
  //     let textWorkCurrent = $('.scworks__text-list .title.active');
  //     textWork.eq(counterTextWork - 1).addClass('active').siblings().removeClass('active');
  //     let textWorkNext = $('.scworks__text-list .title.active');
  // }
  // fadeRepeatText();
  // setInterval(() => {
  //     fadeRepeatText();
  ...
  function sliderTestimonial() {
    var slideUser = document.querySelectorAll('.slide__top-user .userlist .user'),
        slideTitle = document.querySelectorAll('.slide__bottom .titlelist .titlelist__item'),
        slideContent = document.querySelectorAll('.slide__bottom-content .pitem'),
        slideControl = document.querySelectorAll('.sctestimonials__slider .controls .controls__btn'),
        slideDots = document.querySelectorAll('.sctestimonials__slider .slide__timeline ul li'),
        slideCurrent = 0,
        slideInterVal;

    if (slideUser.length) {
      var gotoSlideTes = function gotoSlideTes(to) {
        slideUser[slideCurrent].classList.remove('active');
        slideTitle[slideCurrent].classList.remove('active');
        slideContent[slideCurrent].classList.remove('active');
        slideDots[slideCurrent].classList.remove('active');
        slideUser[to].classList.add('active');
        slideTitle[to].classList.add('active');
        slideContent[to].classList.add('active');
        slideDots[to].classList.add('active');
        slideCurrent = to;
      };

      var autoPlaySlideTes = function autoPlaySlideTes() {
        var timeAutoPlay = 6000;
        gotoSlideTes(slideCurrent);
        slideInterVal = setInterval(function () {
          if (slideCurrent < slideTitle.length - 1) {
            gotoSlideTes(slideCurrent + 1);
          } else {
            gotoSlideTes(0);
          }
        }, timeAutoPlay);
      ...
      autoPlaySlideTes();
      slideControl.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          if (this.classList.contains('--prev')) {
            if (slideCurrent > 0) {
              ...
              gotoSlideTes(slideTitle.length - 1);
            }
          } else {
            if (slideCurrent < slideTitle.length - 1) {
              gotoSlideTes(slideCurrent + 1);
      ...
      slideDots.forEach(function (dots, i) {
  ...
  sliderTestimonial(); ////////////////////////// PRICING /////////////////////////////

  function clickSwiper() {
    var btnSwiper = jquery_default()('.swipebox__btn'),
        textSwiper1 = jquery_default()('.swipebox__text.--text1'),
        textSwiper2 = jquery_default()('.swipebox__text.--text2');
    btnSwiper.click(function () {
      jquery_default()(this).parent().toggleClass('active');
    });
    textSwiper1.click(function () {
      jquery_default()(this).parent().addClass('active');
    });
    textSwiper2.click(function () {
      jquery_default()(this).parent().removeClass('active');
    });
  }

  clickSwiper(); // accordion

  function accordion() {
    var accTitle = jquery_default()('.accordion .accordion__content .accordion__content-title');
    accTitle.on('click', function (e) {
      e.preventDefault();
      jquery_default()(this).next().stop().slideToggle(200);
      var $accordion = jquery_default()(this).closest('.accordion__content');
      $accordion.toggleClass('active');
      jquery_default()(this).closest('.accordion__content').siblings('.active').removeClass('active').find('.accordion__content-text').stop().slideUp(200);
    });
  }

  accordion();

  function pinBoxsPricing() {
    var scPricing = jquery_default()('.scpricing'),
        boxsPricing = jquery_default()('.scpricing__boxs');
    var tlPinBoxsPricing = gsapWithCSS.timeline({
      scrollTrigger: {
        trigger: boxsPricing,
        scroller: scrollMain,
        pin: true,
        start: "top top",
        end: jquery_default()('.scpricing__table-wrap').outerHeight() + 30
      }
    });
  } ////////////////////////// DETECT SCROLL //////////////////////////
  ...
  //         $('.modalsignup.' + datamodal).addClass('active');
  //     })
  // }
  // showModal();
  // // modalSubmit.click(function(e) {
  // //     modalSignup.removeClass('active');
  ...
  //     modalSignup.removeClass('active');
  // });
  // let wpcf7Elm = document.querySelector( '.modal .wpcf7' );
  ...
  // });
  // if ($('.homepage').length) {
  //     let wpcf7ElmHero = document.querySelector('.scmain__form .wpcf7');
  //     wpcf7ElmHero.addEventListener( 'wpcf7mailsent', function( event ) {
  //         modalOverlay.addClass('active');
  //         modalSuccess.addClass('active');
  //     }, false );
  // }
  ...
  // }
  // let btnCloseModal = $('.modal__inner .modal__close');
